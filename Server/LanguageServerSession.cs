...
namespace Lextm.ReStructuredText.LanguageServer
{
    public class SessionState
    {
        ...
        public AnsiCSettings Settings { get; set; } = new AnsiCSettings();

        //public PageInfoStore PageInfoStore { get; } //= new PageInfoStore();

        public CParser WiktextParser { get; }
        public AnsiCProject Project { get; private set; }
    ...
    public class DocumentState
    {
        ...
        public DocumentState(TextDocument doc, CParser parser, ILoggerFactory loggerFactory)
        {
        ...
        public CompilationUnit LintedDocument { get; private set; }
        ...
        private readonly CParser WikitextLinter;         // Not thread-safe
